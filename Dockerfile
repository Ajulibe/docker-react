...
#stage as a light weigh node called alpine

COPY package.json .
# To prevent repeated npm installs anytime we make any change, we'd copy 
#over the package.json and install things first
...
#over to the /app folder in the container
